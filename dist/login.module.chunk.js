...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__backend_service__ = __webpack_require__("../../../../../src/app/backend.service.ts");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, backend, authguard) {
        this.router = router;
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.backend.authUser(this.model.email, this.model.password).subscribe(function (status) {
            if (status.status === 'Success') {
                _this.backend.getUser(status.id).subscribe(function (user) {
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__backend_service__["a" /* BackendService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__backend_service__["a" /* BackendService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__shared_guard_auth_guard__["a" /* AuthGuard */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__shared_guard_auth_guard__["a" /* AuthGuard */]) === "function" && _c || Object])
    ], LoginComponent);
