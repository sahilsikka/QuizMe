...
var map = {
	...
	"./proficiency/proficiency.module": [
	...
	"./question-history/question-history.module": [
		"../../../../../src/app/layout/question-history/question-history.module.ts",
		"common",
		"question-history.module"
	],
	"./quiz-history/quiz-history.module": [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__backend_service__ = __webpack_require__("../../../../../src/app/backend.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_9__shared__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_10__backend_service__["a" /* BackendService */]],
...
var BackendService = /** @class */ (function () {
    function BackendService(http, router) {
        this.http = http;
        this.router = router;
        this.elasticSearchUrl = 'https://search-aw-service-gj2acwxzzkqsr5pnvwy45jsebi.us-east-1.es.amazonaws.com/java_books/';
        this.baseUrl = 'http://quizme-services.us-east-1.elasticbeanstalk.com';
        this.header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        this.http = http;
    }
    BackendService.prototype.getRecommendation = function (data) {
        return this.http.get(this.elasticSearchUrl + "_search?q=" + data)
            .map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.authUser = function (email, password) {
        this.header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
    ...
    BackendService.prototype.createUser = function (payLoad) {
    ...
    BackendService.prototype.getQuizQuestions = function (userId) {
        return this.http.get(this.baseUrl + '/quiz/' + userId)
            .map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.submitAnswers = function (answer) {
        return this.http.post(this.baseUrl + '/quiz', answer)
            .map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.getQuizHistory = function (userId) {
        return this.http.get(this.baseUrl + '/quizHistory/user/' + userId)
            .map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.getUserProficiency = function (userId) {
        return this.http.get(this.baseUrl + '/userProficiency/' + userId)
            .map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.putUserProficiency = function (userId, payload) {
        return this.http.put(this.baseUrl + '/userProficiency/' + userId, JSON.stringify(payload))
            .map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.getCategoryAnalystics = function (userId) {
        this.header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        this.header.append('X-user-id', userId);
        return this.http.get(this.baseUrl + '/analytics/category/', { headers: this.header }).map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.getKnowledgeValues = function (userId) {
        return this.http.get(this.baseUrl + '/userProficiency/knowledge/' + userId).map(function (response) {
            console.log(response);
            return response.json();
        });
    };
    BackendService.prototype.getQuestionHistory = function (quizId, userId) {
        this.header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
    ...
    BackendService.prototype.getQuestionDiscussion = function (questionId) {
        return this.http.get(this.baseUrl + '/discussion/' + questionId).map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.postDiscussion = function (payLoad) {
        this.header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        this.header.append('Content-Type', 'application/json');
        console.log((payLoad));
        return this.http.post(this.baseUrl + '/discussion/post', JSON.stringify(payLoad), { headers: this.header }).map(function (response) {
            return response;
        });
    };
    BackendService.prototype.incrementUpvote = function (postId) {
        return this.http.put(this.baseUrl + '/discussion/upvote/' + postId, {}).map(function (response) {
            return response.json();
        });
    };
    BackendService.prototype.incrementDownVote = function (postId) {
        return this.http.put(this.baseUrl + '/discussion/downvote/' + postId, {}).map(function (response) {
            return response.json();
        });
    };
...
module.exports = "<nav class=\"sidebar\" [ngClass]=\"{sidebarPushRight: isActive}\">\n    <ul class=\"list-group\">\n        <a routerLink=\"/dashboard\" [routerLinkActive]=\"['router-link-active']\" class=\"list-group-item\">\n            <i class=\"fa fa-fw fa-dashboard\"></i>&nbsp;{{ 'Dashboard' | translate }}\n        </a>\n        <a [routerLink]=\"['/profile']\" [routerLinkActive]=\"['router-link-active']\" class=\"list-group-item\">\n            <i class=\"fa fa-fw fa-edit\"></i>&nbsp;{{ 'Profile' | translate }}\n        </a>\n        <a [routerLink]=\"['/proficiency']\" [routerLinkActive]=\"['router-link-active']\" class=\"list-group-item\">\n            <i class=\"fa fa-star\"></i>&nbsp;{{ 'Proficiency' | translate }}\n        </a>\n        <a [routerLink]=\"['/quiz']\" [routerLinkActive]=\"['router-link-active']\" class=\"list-group-item\">\n            <i class=\"fa fa-fw fa-wrench\"></i>&nbsp;{{ 'Start Quiz' | translate }}\n        </a>\n        <a [routerLink]=\"['/quiz-history']\" [routerLinkActive]=\"['router-link-active']\" class=\"list-group-item\">\n            <i class=\"fa fa-book\"></i>{{ 'Quiz History' | translate }}\n        </a>\n    </ul>\n</nav>\n"
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_4__models__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__option__ = __webpack_require__("../../../../../src/app/shared/models/option.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__question__ = __webpack_require__("../../../../../src/app/shared/models/question.ts");
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__quiz__ = __webpack_require__("../../../../../src/app/shared/models/quiz.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__quiz_config__ = __webpack_require__("../../../../../src/app/shared/models/quiz-config.ts");
/* unused harmony namespace reexport */
...
var Option = /** @class */ (function () {
    ...
    Option.prototype.getChoice = function () {
        return this.choice;
    };
    ...
    function Question(data) {
        ...
        if (data.choiceA != null) {
            if (data.answer === 'ChoiceA')
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](1, data.id, data.choiceA, "ChoiceA", true));
            else
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](1, data.id, data.choiceA, "ChoiceA", false));
        }
        if (data.choiceB != null) {
            if (data.answer === 'ChoiceB')
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](2, data.id, data.choiceB, "ChoiceB", true));
            else
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](2, data.id, data.choiceB, "ChoiceB", false));
        }
        if (data.choiceC != null) {
            if (data.answer === 'ChoiceC')
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](3, data.id, data.choiceC, "ChoiceC", true));
            else
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](3, data.id, data.choiceC, "ChoiceC", false));
        }
        if (data.choiceD != null) {
            if (data.answer === 'ChoiceD')
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](4, data.id, data.choiceD, "ChoiceD", true));
            else
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](4, data.id, data.choiceD, "ChoiceD", false));
        }
        if (data.choiceE != null) {
            if (data.answer === 'ChoiceE')
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](5, data.id, data.choiceE, "ChoiceE", true));
            else
                this.options.push(new __WEBPACK_IMPORTED_MODULE_0__option__["a" /* Option */](5, data.id, data.choiceE, "ChoiceE", false));
        }
...
/***/ "../../../../../src/app/shared/models/quiz-config.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../../../../src/app/shared/models/quiz.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Quiz; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__question__ = __webpack_require__("../../../../../src/app/shared/models/question.ts");
